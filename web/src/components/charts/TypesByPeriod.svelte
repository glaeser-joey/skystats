<script>
    ...
    let endpoint = 'api/stats/types/top/' + period
...
{:else}
    ...
    <li class="list-row">
        <div class="flex items-center justify-center">
            ...
            <span class="!text-md sm:!text-lg md:!text-xl lg:!text-2xl font-thin text-accent opacity-80 font-mono" style="white-space: pre;">{type.aircraft_type.padEnd(4, ' ')}</span>
        </a></div>
        </div>
