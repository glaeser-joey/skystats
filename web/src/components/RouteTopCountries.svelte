...
{:else}
    ...
    <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">Top Countries</li>
    ...
    <li class="list-row">
        ...
        <div class="font-medium">{topCountry.country}</div>
        <div class="text-xs uppercase font-semibold opacity-60">{topCountry.country_iso}</div>
        </div>
        <div class="text-right">
            <div class="font-semibold">{topCountry.count.toLocaleString()}</div>
